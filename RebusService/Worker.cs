...
/// <summary>
/// This approach is based on Mogens' answer here: https://stackoverflow.com/a/60631521/2608
/// </summary>
public class Worker : BackgroundService
{
    ...
    public Worker()
    {
        ...
        // Using Rebus with the file system transport.  Using an audit queue so you can see the messages that have been processed.
        _services.AddRebus(
                rebus => rebus
                   .Logging  (l => l.Console())
